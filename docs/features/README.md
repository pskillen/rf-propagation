...
| Reach | [reach/README.md](reach/README.md) | Shipped — 2D coverage map with a live-draggable station marker, canvas ground-shading (hop-band hue, reliability opacity), a legend, a best-band-now summary strip, and cell-selection target recording; the 3D globe (phase 9), transport control/permalink/presets (phase 10) and the full Path view (phase 13) are not yet built |
